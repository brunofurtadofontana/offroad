...
CREATE TABLE IF NOT EXISTS `offroadv1`.`Evento` (
  ...
  `evenVlrAtualizado` FLOAT NULL,
  `promoter_idUsuario` INT(11) NOT NULL,
  `evenJustifica` VARCHAR(255) NULL,
  `evenJustVlr` VARCHAR(255) NULL,
  `evenDataSoli` DATETIME NULL,
  `evenDataSoliVlr` DATETIME NULL,
  `evenDataResExc` DATETIME NULL,
  `evenDataResVlr` DATETIME NULL,
  `usuResVlr` VARCHAR(45) NULL,
  `usuResExc` VARCHAR(45) NULL,
