<?php
  ...
  $qr_pagamento = mysqli_query($con,"SELECT * from pagamento WHERE Evento_idEventos = '$idEventos';")or die(mysqli_error($con));
  $showpag =  mysqli_fetch_assoc($qr_pagamento);
  $pagTipo = $showpag['pagTipo'];
  $pagValor = $showpag['pagValor'];
  $pagData = $showpag['pagData'];
  $pagStatus = $showpag['pagStatus'];
  $pagQrCode = $showpag['pagQrCode'];
      ...
      <div class="layout-content">
        ...
        <!-- Detalhes Começa Aqui -->
            <h4 class="font-weight-bold py-3 mb-4">
              ...
              <?php
                  if($pagStatus == '1'){ 
                       echo "<span class='text-big'><span class='badge badge-success'>Pago</span></span>";
                
                      }else{
                
                      echo "<span class='text-big'><span class='badge badge-danger'>Pagamento em Aberto</span></span>";
                      }
                ?>
            </h4>
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-2 mb-3">
                    <div class="text-muted small">Valor Pagamento</div>
                    <?php echo 'R$' . number_format($pagValor, 2, ',', '.'); ?>
                  </div>
                  <div class="col-md-2 mb-3">
                    <div class="text-muted small">Status do Pagamento</div>
                    <?php 
                      if($pagStatus == '1'){ 
                       echo "<span class='text-big'><span class='badge badge-success'>Pago</span></span>";
                  ...
                  <div class="col-md-2 mb-3">
                    <div class="text-muted small">Data Pagamento</div>
                      <span><?php echo date('d/m/Y', strtotime($pagData));?></span>
                  </div>
                  <div class="col-md-2 mb-3">
                    <div class="text-muted small">Tipo do Pagamento</div>
                      <span><?php echo $pagTipo; ?></span>
                  </div>
                  <div class="col-md-2 mb-3">
                    <div class="text-muted small">QR Code</div>
                      <span>
                        <?php 
                          if ($pagQrCode == '1') {
                            echo "<a href='' data-toggle='modal' data-target='#myModalQR$idEventos'>
                             <span lass='text-big'>
                             <span class='badge badge-success'>QR CODE Disponivel</span></span></a>";
                              
                          }else if($pagQrCode == '3'){
                            echo "<span lass='text-big'>
                             <span class='badge badge-warning'>QR CODE Utilizado</span></span></a>";
                          }
                          else{
                            echo "<span lass='text-big'>
                             <span class='badge badge-danger'>QR CODE Indisponivel</span></span></a>";
                          }
                        ?>   
                      </span>
                  </div>
            ...
            <hr class="m-0">
              ...
              <hr class="m-0">
                <div class="card-body">
                  <h6 class="small font-weight-semibold">
                    Informações dos Valores do Evento
                  </h6>
                  <div class="row">
                    <div class="col-md-4 mb-4">
              ...
              <!-- MODAL PARA ABRIR QRCODE -->
                <div class="modal fade" id="myModalQR<?php if($idEventos==$idEventos)echo $idEventos;?>">
                    ...
                    <form class="modal-content" method="post" action="../config/tratadados.php?opc=9&idEvento=<?php echo $idEven ?>" autocomplete="on">
                      <div class="modal-header">
                        <h5 class="modal-title">
                          QR CODE Evento #<?php echo $idEven; ?>
                          <br>
