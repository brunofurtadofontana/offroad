    ...
    <div class="authentication-inner py-5">
      ...
      <div class="card">
        <div class="p-4 px-sm-5 pt-sm-5">
          ...
          <h5 class="text-center text-muted font-weight-normal mb-4">Criar uma conta</h5>
          ...
          <form>
            ...
            <div class="text-light small mt-4">
              Ao clicar em Entrar você concorda com os termos de serviços e 
              <a href="">termos de servicos e politica de privacidade</a>.
